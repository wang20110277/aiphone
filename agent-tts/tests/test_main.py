...
from ttsadapter.main import app
from ttsadapter.base import TTSResult
...
async def test_synthesize_json():
    import ttsadapter.main as main_mod
    ...
    with patch("ttsadapter.store.storage.build_object_key", return_value="tts/20260514/call123.wav"), \
